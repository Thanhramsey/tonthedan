	...
	<section class="content-header">
		...
		<div class="breadcrumb">
			...
			<a class="btn btn-primary btn-sm" href="<?php echo base_url() ?>admin/sliders/recyclebin" role="button">
				<span class="glyphicon glyphicon-trash"></span> Thùng rác(<?php $total = $this->Msliders->slider_trash_count();
																			echo $total; ?>)
			</a>
		</div>
	</section>
											...
											<?php foreach ($list as $row) : ?>
												<tr>
													...
													<td style="width:100px">
														<img src="./public/assets/images/product/<?php echo $row['img'] ?>" class="img-responsive">
													</td>
