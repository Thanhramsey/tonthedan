							...
							<div class="col-md-9">
								...
								<div class="form-group">
									...
									<div class="anh" style ="width:300px; height:280px; border:1px dashed black;border-radius:10px; padding: 5px; margin-bottom:10px">
										<!-- Chứa ảnh ở đây -->
										<img style="width:100%; height:100%;border-radius:10px" id="output" src="./public/assets/images/product/<?php echo $row['img'] ?>" />
									</div>
								...
								<div class="form-group">
									...
									<div class="anh" style ="width:100%; height:280px; border:1px dashed black;border-radius:10px; padding: 5px; margin-bottom:10px">
										<!-- Chứa ảnh ở đây -->
										<img style="width:32%;margin-right:5px;border-right:1px solid black; height:100%;border-radius:10px" id="output1" src="./public/assets/images/product/<?php echo $row['img1'] ?>" />
										<img style="width:32%;margin-right:5px;border-right:1px solid black; height:100%;border-radius:10px" id="output2" src="./public/assets/images/product/<?php echo $row['img2'] ?>" />
										<img style="width:32%;margin-right:5px; height:100%;border-radius:10px" id="output3" src="./public/assets/images/product/<?php echo $row['img3'] ?>" />
									</div>
								</div>
								<div class="form-group">
							...
							<div class="col-md-3">
								...
								<div class="form-group">
									...
									<select name="type" class="form-control">
										<option value="0" <?php if($row['type'] == 0) {echo 'selected';}?> >Tôn</option>
										<option value="1" <?php if($row['type'] == 1) {echo 'selected';}?>>Ngói</option>
										<option value="2" <?php if($row['type'] == 2) {echo 'selected';}?>>Sắt, thép, xà gỗ</option>
									</select>
								</div>
							</div>
						</div>
